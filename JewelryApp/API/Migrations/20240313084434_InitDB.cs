    ...
    public partial class InitDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Activitie", x => x.ActivityId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsernameNavigationId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CheckLogs", x => x.LogId);
                    table.ForeignKey(
                        name: "FK_CheckLogs_Activitie_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "Activitie",
                        principalColumn: "ActivityId");
                    table.ForeignKey(
                        name: "FK_CheckLogs_AspNetUsers_UsernameNavigationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_AspNetUsers_UsernameNavigationId",
                        column: x => x.UsernameNavigationId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CheckLogs_ActivityId",
                table: "CheckLogs",
                column: "ActivityId");

            migrationBuilder.CreateIndex(
                name: "IX_CheckLogs_UsernameNavigationId",
                table: "CheckLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_UsernameNavigationId",
                table: "Orders",
                column: "UsernameNavigationId");
