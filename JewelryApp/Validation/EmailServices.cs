    ...
    public class EmailServices 
    {
        ...
        public EmailServices()
        {
            _emailConfiguration = new EmailConfiguration
            {
                ...
                Port = 587,
                From = "anhoangminh02@gmail.com",
                SmtpUsername = "anhoangminh02",
                SmtpPassword = "qugb oldl jgnf wmcm"
            };
        }
        ...
        public async Task SendAsync(EmailMessage emailMessage)
        {
            ...
            message.From.Add(new MailboxAddress("Jewerly System", _emailConfiguration.From));
